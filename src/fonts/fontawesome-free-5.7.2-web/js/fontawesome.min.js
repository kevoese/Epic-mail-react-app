!(function() {
  ...
  var c = (e.navigator || {}).userAgent,
    ...
    O = { fas: 'solid', far: 'regular', fal: 'light', fab: 'brands', fa: 'solid' },
    E = { solid: 'fas', regular: 'far', light: 'fal', brands: 'fab' },
    j = 'fa-layers-text',
    P = /Font Awesome 5 (Solid|Regular|Light|Brands|Free|Pro)/,
    L = { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal' },
  ...
  var D = Y[v],
    ...
    W = !1;
  function X(t) {
    g && (W ? setTimeout(t, 0) : q.push(t));
  }
  g &&
    ((W = (p.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(p.readyState)) ||
  ...
  var K,
    ...
    et = 'undefined' == typeof setImmediate ? setTimeout : setImmediate,
    nt = [];
  function at() {
  ...
  function st(t, e) {
    t._state === G && ((t._state = J), (t._data = e), rt(ut, t));
  }
  function lt(t, e) {
    t._state === G && ((t._state = J), (t._data = e), rt(dt, t));
  }
  function ft(t) {
  ...
  function dt(t) {
    (t._state = Z),
      ft(t),
      !t._handled && tt && global.process.emit('unhandledRejection', t._data, t);
  }
  function mt(t) {
  ...
  (ht.prototype = {
    ...
    _handled: !1,
    then: function(t, e) {
      var n = { owner: this, then: new this.constructor($), fulfilled: t, rejected: e };
      return (
        (!e && !t) ||
          this._handled ||
          ((this._handled = !0), this._state === Z && tt && rt(mt, this)),
        this._state === Q || this._state === Z ? rt(it, n) : this._then.push(n),
        n.then
      );
    },
    catch: function(t) {
    ...
    (ht.resolve = function(e) {
      return e && 'object' === r(e) && e.constructor === ht
        ? e
        : new ht(function(t) {
            t(e);
          });
    }),
    (ht.reject = function(n) {
      return new ht(function(t, e) {
        e(n);
      });
    });
  var pt = 'function' == typeof Promise ? Promise : ht,
    gt = A,
  ...
  function wt() {
    for (var t = 12, e = ''; 0 < t--; ) e += yt[(62 * Math.random()) | 0];
    return e;
  }
  function xt(t) {
  ...
  function Ot(t) {
    var e = t.icons,
      ...
      g = [V.replacementClass, i ? ''.concat(V.familyPrefix, '-').concat(i) : '', p]
        .filter(function(t) {
    ...
    u && (v.attributes[U] = ''),
      s &&
        v.children.push({
          tag: 'title',
          attributes: { id: v.attributes['aria-labelledby'] || 'title-'.concat(wt()) },
          children: [s],
        });
    var b,
      y,
      ...
      q =
        a.found && n.found
          ? ((y = (b = D).children),
            ...
            (S = k.width),
            (z = k.icon),
            (M = zt({ transform: A, containerWidth: S, iconWidth: C })),
            (O = { tag: 'rect', attributes: B({}, Mt, { fill: 'white' }) }),
            (E = {
              tag: 'g',
              attributes: B({}, M.inner),
              children: [
                { tag: 'path', attributes: B({}, N.attributes, M.path, { fill: 'black' }) },
              ],
            }),
            (j = { tag: 'g', attributes: B({}, M.outer), children: [E] }),
            (P = 'mask-'.concat(wt())),
            (L = 'clip-'.concat(wt())),
            (_ = {
              tag: 'defs',
              children: [
                { tag: 'clipPath', attributes: { id: L }, children: [z] },
                {
                  tag: 'mask',
                  attributes: B({}, Mt, {
                    id: P,
          ...
          : (function(t) {
              var e = t.children,
                ...
                r = t.transform,
                i = Nt(t.styles);
              if ((0 < i.length && (n.style = i), St(r))) {
                var o = zt({ transform: r, containerWidth: a.width, iconWidth: a.width });
                e.push({
                  tag: 'g',
                      ...
                      children: [
                        {
                          ...
                          attributes: B({}, a.icon.attributes, o.path),
                        },
                      ],
                    },
                  ],
  ...
  function Et(t) {
    var e = t.content,
      ...
      c = t.watchable,
      s = void 0 !== c && c,
      l = B({}, o.attributes, i ? { title: i } : {}, { class: o.classes.join(' ') });
    s && (l[U] = '');
    var f,
      u,
      d,
    ...
    St(r) &&
      ((y.transform =
        ...
        (b +=
          (v = void 0 !== g && g) && k
            ? 'translate('.concat(u.x / gt - m / 2, 'em, ').concat(u.y / gt - p / 2, 'em) ')
            : v
            ? 'translate(calc(-50% + '
                .concat(u.x / gt, 'em), calc(-50% + ')
                .concat(u.y / gt, 'em)) ')
            : 'translate('.concat(u.x / gt, 'em, ').concat(u.y / gt, 'em) ')),
        (b += 'scale('
          .concat((u.size / gt) * (u.flipX ? -1 : 1), ', ')
          .concat((u.size / gt) * (u.flipY ? -1 : 1), ') ')),
  ...
  var jt = function() {},
    Pt = V.measurePerformance && f && f.mark && f.measure ? f : { mark: jt, measure: jt },
    Lt = 'FA "5.7.2"',
    _t = function(t) {
      Pt.mark(''.concat(Lt, ' ').concat(t, ' ends')),
        Pt.measure(
          ''.concat(Lt, ' ').concat(t),
          ''.concat(Lt, ' ').concat(t, ' begins'),
          ''.concat(Lt, ' ').concat(t, ' ends')
        );
    },
    Tt = {
      begin: function(t) {
        return (
          Pt.mark(''.concat(Lt, ' ').concat(t, ' begins')),
          function() {
            return _t(t);
          }
        );
  ...
  function Ut(t) {
    return t.reduce(function(t, e) {
      var n = At(V.familyPrefix, e);
      if (Xt[e]) t.prefix = e;
      else if (V.autoFetchSvg && -1 < ['fas', 'far', 'fal', 'fab', 'fa'].indexOf(e)) t.prefix = e;
      else if (n) {
        var a = 'fa' === t.prefix ? Dt[n] || { prefix: null, iconName: null } : {};
        (t.iconName = a.iconName || n), (t.prefix = a.prefix || t.prefix);
      } else e !== V.replacementClass && 0 !== e.indexOf('fa-w-') && t.rest.push(e);
      return t;
    }, Bt());
  }
  function Vt(t, e, n) {
    ...
    return 'string' == typeof t
      ...
      : '<'
          ...
          .concat(
            ...
            Object.keys(n || {})
              .reduce(function(t, e) {
                return t + ''.concat(e, '="').concat(Ct(n[e]), '" ');
              }, '')
              .trim()),
            '>'
          )
          .concat(o.map(Kt).join(''), '</')
          .concat(e, '>');
  }
  var Gt = function() {};
  function Jt(t) {
  ...
  var Qt = {
    ...
    nest: function(t) {
      var e = t[0],
        n = t[1];
      if (~kt(e).indexOf(V.replacementClass)) return Qt.replace(t);
      var a = new RegExp(''.concat(V.familyPrefix, '-.*'));
      delete n[0].attributes.style;
      var r = n[0].attributes.class.split(' ').reduce(
        function(t, e) {
          return e === V.replacementClass || e.match(a) ? t.toSvg.push(e) : t.toNode.push(e), t;
        },
        { toNode: [], toSvg: [] }
      );
      ...
      var i = n
        ...
        .join('\n');
      e.setAttribute('class', r.toNode.join(' ')), e.setAttribute(U, ''), (e.innerHTML = i);
    },
  };
  function Zt(n, t) {
    ...
    0 === n.length
      ...
      : (h.requestAnimationFrame ||
          ...
          var t = !0 === V.autoReplaceSvg ? Qt.replace : Qt[V.autoReplaceSvg] || Qt.replace,
            e = Tt.begin('mutate');
          n.map(t), e(), a();
        });
  }
  ...
  function ne(t) {
    if (l && V.observeMutations) {
      ...
      (ee = new l(function(t) {
          ...
          xt(t).forEach(function(t) {
            if (
              ('childList' === t.type &&
                ...
                !Jt(t.addedNodes[0]) &&
                (V.searchPseudoElements && o(t.target), r(t.target)),
              'attributes' === t.type &&
                t.target.parentNode &&
                V.searchPseudoElements &&
                o(t.target.parentNode),
              'attributes' === t.type && Jt(t.target) && ~R.indexOf(t.attributeName))
            )
              if ('class' === t.attributeName) {
                var e = Ut(kt(t.target)),
                  n = e.prefix,
                  a = e.iconName;
        ...
        g && ee.observe(n, { childList: !0, attributes: !0, characterData: !0, subtree: !0 });
    }
  }
  function ae(t) {
  ...
  function re(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ? (o.iconName = ((e = o.prefix), (n = t.innerText), Yt[e][n]))
        : o.prefix && 1 === i.length && (o.iconName = Wt(o.prefix, ae(t.innerText))),
      o
    );
  }
  var ie = function(t) {
  ...
  function oe(t) {
    var e,
      ...
      d =
        ...
        n),
      m = ie(t.getAttribute('data-fa-transform')),
      h = null !== (a = t.getAttribute('data-fa-symbol')) && ('' === a || a),
      p =
        ((i = xt((r = t).attributes).reduce(function(t, e) {
          return 'class' !== t.name && 'style' !== t.name && (t[e.name] = e.value), t;
        }, {})),
        (o = r.getAttribute('title')),
        V.autoA11y &&
          (o
            ? (i['aria-labelledby'] = ''.concat(V.replacementClass, '-title-').concat(wt()))
  ...
  var se = { fill: 'currentColor' },
    le = { attributeType: 'XML', repeatCount: 'indefinite', dur: '2s' },
    fe = {
      tag: 'path',
      attributes: B({}, se, {
        d:
    ...
    de = {
      ...
      children: [
        ...
        {
          tag: 'circle',
          attributes: B({}, se, { cx: '256', cy: '364', r: '28' }),
          children: [
            {
              tag: 'animate',
              attributes: B({}, le, { attributeName: 'r', values: '28;14;28;28;14;28;' }),
            },
            { tag: 'animate', attributes: B({}, ue, { values: '1;0;1;1;0;1;' }) },
          ],
        },
        {
          tag: 'path',
          ...
          children: [{ tag: 'animate', attributes: B({}, ue, { values: '1;0;0;0;0;1;' }) }],
        },
        {
          tag: 'path',
          attributes: B({}, se, {
          ...
          children: [{ tag: 'animate', attributes: B({}, ue, { values: '0;0;1;1;0;0;' }) }],
        },
      ],
    },
    me = D.styles;
  function he(r, i) {
    return new pt(function(t, e) {
      var n = { found: !1, width: 512, height: 512, icon: de };
      if (r && i && me[i] && me[i][r]) {
        var a = me[i][r];
        return t(
          (n = {
            ...
            width: a[0],
            height: a[1],
            icon: { tag: 'path', attributes: { fill: 'currentColor', d: a.slice(4)[0] } },
          })
        );
      }
      r && i && !V.showMissingIcons
        ? e(new ce('Icon is missing for prefix '.concat(i, ' with icon name ').concat(r)))
        : t(n);
    });
  }
  var pe = D.styles;
  function ge(t) {
    ...
    return ~a.extra.classes.indexOf(j)
      ? (function(t, e) {
          ...
          return (
            V.autoA11y && !n && (r.attributes['aria-hidden'] = 'true'),
            pt.resolve([
              t,
              Et({
                content: t.innerHTML,
      ...
      : ((i = t),
        ...
        (u = e.extra),
        new pt(function(r, t) {
          pt.all([he(o, s), he(n.iconName, n.prefix)]).then(function(t) {
            var e = d(t, 2),
              n = e[0],
              a = e[1];
            r([
  ...
  function ve(t) {
    ...
    if (g) {
      var e = p.documentElement.classList,
        ...
        i = V.autoFetchSvg ? Object.keys(O) : Object.keys(pe),
        o = ['.'.concat(j, ':not([').concat(U, '])')]
          .concat(
            i.map(function(t) {
          ...
          var s = Tt.begin('onTree'),
            l = c.reduce(function(t, e) {
              try {
                ...
                M || (t instanceof ce && console.error(t));
              }
              return t;
            }, []);
  ...
  function ye(u, d) {
    var m = ''.concat(x).concat(d.replace(':', '-'));
    return new pt(function(a, t) {
      if (null !== u.getAttribute(m)) return a();
      var e = xt(u.children).filter(function(t) {
          return t.getAttribute(w) === d;
        })[0],
        n = h.getComputedStyle(u, d),
        r = n.getPropertyValue('font-family').match(P),
        i = n.getPropertyValue('font-weight');
      if (e && !r) return u.removeChild(e), a();
      if (r) {
        var o = n.getPropertyValue('content'),
          c = ~['Light', 'Regular', 'Solid', 'Brands'].indexOf(r[1]) ? E[r[1].toLowerCase()] : L[i],
          s = Wt(c, ae(3 === o.length ? o.substr(1, 1) : o));
        if (e && e.getAttribute(C) === c && e.getAttribute(N) === s) a();
        else {
          u.setAttribute(m, s), e && u.removeChild(e);
          var l = {
              iconName: null,
              title: null,
              prefix: null,
            ...
            he(s, c)
              .then(function(t) {
                var e = Ot(
                  ...
                  n = p.createElement('svg');
                ':before' === d ? u.insertBefore(n, u.firstChild) : u.appendChild(n),
                  (n.outerHTML = e
                    .map(function(t) {
                      return Kt(t);
                    })
  ...
  function we(t) {
    return pt.all([ye(t, ':before'), ye(t, ':after')]);
  }
  function xe(t) {
    return !(
  ...
  function Me(t) {
    var e = t.prefix,
      n = void 0 === e ? 'fa' : e,
      a = t.iconName;
    if (a) return Vt(Ee.definitions, n, a) || Vt(D.styles, n, a);
  }
  var Oe,
    Ee = new ((function() {
      function t() {
        ...
        (n = [
          {
            ...
            value: function() {
              ...
              Object.keys(r).forEach(function(t) {
                (e.definitions[t] = B({}, e.definitions[t] || {}, r[t])),
                  (function t(e, a) {
                    ...
                    'function' != typeof D.hooks.addPack || r
                      ? (D.styles[e] = B({}, D.styles[e] || {}, i))
                      : D.hooks.addPack(e, i),
                      'fas' === e && t('fa', a);
                  })(t, r[t]),
                  qt();
    ...
    Pe = {
      i2svg: function() {
        ...
        if (g) {
          ...
          return V.searchPseudoElements && ke(n), ve(n, r);
        }
    ...
    Le =
      ((Oe = function(t) {
        ...
        if (t) {
          var g = t.prefix,
            v = t.iconName,
            b = t.icon;
          return ze(B({ type: 'icon' }, t), function() {
            return (
              Se(),
              V.autoA11y &&
                (l
                  ? (m['aria-labelledby'] = ''.concat(V.replacementClass, '-title-').concat(wt()))
                  : ((m['aria-hidden'] = 'true'), (m.focusable = 'false'))),
              Ot({
                icons: {
                  main: Ne(b),
                  mask: c ? Ne(c.icon) : { found: !1, width: null, height: null, icon: {} },
                },
                prefix: g,
                iconName: v,
                transform: B({}, vt, a),
      ...
      function(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          n = (t || {}).icon ? t : Me(t || {}),
          a = e.mask;
        return a && (a = (a || {}).icon ? a : Me(a || {})), Oe(n, B({}, e, { mask: a }));
      }),
    _e = {
      noAuto: function() {
        (V.autoReplaceSvg = !1), (V.observeMutations = !1), ee && ee.disconnect();
      },
      config: V,
      dom: Pe,
      library: Ee,
      ...
      text: function(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          f = e.styles,
          u = void 0 === f ? {} : f;
        return ze({ type: 'text', content: t }, function() {
          return (
            Se(),
            Et({
              content: t,
              ...
              extra: {
                attributes: l,
                styles: u,
                classes: [''.concat(V.familyPrefix, '-layers-text')].concat(m(c)),
              },
            })
          );
        });
      ...
      counter: function(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          s = e.styles,
          l = void 0 === s ? {} : s;
        return ze({ type: 'counter', content: t }, function() {
          return (
            Se(),
            (function(t) {
              var e = t.content,
                n = t.title,
                a = t.extra,
                r = B({}, a.attributes, n ? { title: n } : {}, { class: a.classes.join(' ') }),
                i = Nt(a.styles);
        ...
        return ze({ type: 'layer' }, function() {
          ...
          return (
            ...
            [
              {
                tag: 'span',
                attributes: { class: ''.concat(V.familyPrefix, '-layers') },
                children: e,
              },
            ]
          );
    ...
    Te = function() {
      var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {})
          .autoReplaceSvgRoot,
        e = void 0 === t ? p : t;
      (0 < Object.keys(D.styles).length || V.autoFetchSvg) &&
        g &&
        V.autoReplaceSvg &&
        _e.dom.i2svg({ node: e });
    };
  !(function(t) {
    ...
    u &&
      (h.FontAwesome || (h.FontAwesome = _e),
      X(function() {
        Te(), ne({ treeCallback: ve, nodeCallback: be, pseudoElementsCallback: ke });
      })),
      (D.hooks = B({}, D.hooks, {
        addPack: function(t, e) {
          (D.styles[t] = B({}, D.styles[t] || {}, e)), qt(), Te();
        },
        addShims: function(t) {
          var e;
          (e = D.shims).push.apply(e, m(t)), qt(), Te();
        },
      }));
  });
})();
