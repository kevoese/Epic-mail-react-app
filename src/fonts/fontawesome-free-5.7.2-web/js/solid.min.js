!(function() {
  ...
  var l = (c.navigator || {}).userAgent,
    ...
    M =
      (z.document,
      !!s.documentElement && !!s.head && 'function' == typeof s.addEventListener && s.createElement,
  ...
  function V(c, v) {
    ...
    'function' != typeof a.hooks.addPack || l
      ? (a.styles[c] = (function(z) {
          for (var c = 1; c < arguments.length; c++) {
            var s = null != arguments[c] ? arguments[c] : {},
              h = Object.keys(s);
            'function' == typeof Object.getOwnPropertySymbols &&
              (h = h.concat(
                Object.getOwnPropertySymbols(s).filter(function(c) {
